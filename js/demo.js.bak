	 ...
	 addHandler(mark,'swipeUp',function(){
		startMove(menu,{top:-300});
	 });
	 addHandler(mark,'swipeDown',function(){
		startMove(menu,{top:0});
	 });
    //初始化音量 
	 audio.volume=0.5;
	 //音量按钮
   ...
   function getlistMusic(type){
     ...
     script.src='http://tingapi.ting.baidu.com/v1/restserver/ting?format=json&callback=hanlderList&from=webapp_music&method=baidu.ting.billboard.billList&type='+type+'&size=8&offset=0';
